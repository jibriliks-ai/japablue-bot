"""
Japablueprint Bot - RENDER FIXED VERSION - Guaranteed to start
"""
...
# Flask app - ALWAYS defined, no fallback that causes exit 2
flask_app = Flask(__name__)

@flask_app.route("/")
def home():
    return f"Japablueprint Bot Running ✅ Channel={CHANNEL_ID}<br>Health: <a href='/health'>/health</a><br>BOT_TOKEN set: {bool(BOT_TOKEN)}<br>Time: {datetime.now()}"
